...
<html>
    ...
    <body>
            ...
            <tbody style="text-align:center;">
                <?php 
                    ...
                    while($dt_histori=mysqli_fetch_array($qry_histori)){
                        $no++;
                        $button_lunas="<a href='lunas.php?id=".$dt_histori['id_transaksi']."' class='btn btn-danger' onclick='return confirm(\"Apakah anda yakin?\")'>Lunas</a>";
        ...
        <ul>
<a class="btn btn-primary" href="hapus_histori.php" onclick="return confirm('Apakah anda yakin menghapus data ini?')" class="btn btn-secondary"> Hapus Histori</a>
    </body>
</html>